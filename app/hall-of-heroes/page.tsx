    ...
    <div className="bg-background text-foreground">
      <section className="container-width py-16 space-y-12">
        <div className="space-y-6 max-w-3xl">
          <TapSeal label="Hall of Heroes" detail="Community Impact" />
          <h1 className="h1">Mission Reports from the Field</h1>
          <p className="text-lg leading-relaxed text-muted-foreground">
            Real heroes, real missions, real impact. Every profile is verified and shares how TAP gear
            supports their work.
          </p>
        </div>
